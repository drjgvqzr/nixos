{
    ...
    home-manager.users.soma.programs.zsh = {
        ...
        initContent = ''
            ...
            abbrev-alias lv="tree -DhL 1 --timefmt=\"| %m.%d %H:%M\"| nvim -R +AnsiEsc"
            abbrev-alias lt="tree -DcL 1 --timefmt=\"| %m.%d %H:%M\"| nvim -R +AnsiEsc"
            abbrev-alias lS="tree --sort=size -hL 1| nvim -R +AnsiEsc"
